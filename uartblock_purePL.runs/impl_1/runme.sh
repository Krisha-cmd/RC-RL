...
HD_PWD='C:/Users/iamri/Documents/Subham_UART/uartblock_purePL/uartblock_purePL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_pipeline_with_grayscale.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_pipeline_with_grayscale.tcl -notrace
